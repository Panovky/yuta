...
def parse_lk(response: Response) -> dict:
    """
    Принимает ответ сервера ЯГТУ на запрос авторизации и возвращает словарь с данными о студенте из его личного кабинета.

    :param response: объект ответа сервера ЯГТУ на запрос авторизации.
